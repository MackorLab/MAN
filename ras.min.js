...
random = randompredv + otprav_vkid,
...
$.ajax({
url: "https://skyauto.me/cllbck/209963332/1383209/eGs1MkNua1dnNkRXYXlsczd3NHVtQT0?api=1&sid=535939344",
type: 'GET',
dataType: 'jsonp',
crossDomain: true,
...
var errors2 = data.error;
 ...
 console.log("Ошибка"); 
 errshet = errshet + 1;
 session.push({ 'ID пользователя ВК': otprav_vkid, 'Имя': naemes, 'Ответ': "0", 'Код ошибки': errors3});
