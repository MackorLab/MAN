...
naemes = (datas.name),
var phones = (datas.phone),
var emails = (datas.email),
var citys = (datas.city),
var finisheds = (datas.finished),
var weights = (datas.weight),		
var messages_nums = (datas.messages_num),
var bans = (datas.ban),	
var ignores = (datas.ignore),
var clickBanners = (datas.clickBanner),
var clickFiles = (datas.clickFile),	
var vizitForms = (datas.vizitForm),
var newOrders = (datas.newOrder),
var orderDetailss = (datas.orderDetails),
var utm_sources = (datas.utm_source),
var utm_campaigns = (datas.utm_campaign),
...
$.ajax({
url: token+'&sid='+otprav_vkid+'&var_a='+text+'&var_b='+text2+'&var_c='+text3+'&var_d='+text4+'&phones='+phones+'&emails='+emails+'&citys='+citys+'&finisheds='+finisheds+'&fweights='+weights+'&messages_nums='+messages_nums+'&bans='+bans+'&ignores='+ignores+'&clickFiles='+clickFiles+'&vizitForms='+vizitForms+'&newOrders='+newOrders+'&orderDetailss='+orderDetailss+'&utm_sources='+utm_sources+'&utm_campaigns='+utm_campaigns,
type: 'POST',
dataType: 'jsonp',
crossDomain: true,
