...
$.ajax({
url: token+'&sid='+otprav_vkid+'&var_a='+text+'&var_b='+text2+'&var_c='+text3+'&var_d='+text4+'&phones='+phones+'&emails='+emails+'&citys='+citys+'&finisheds='+finisheds+'&fweights='+weights+'&messages_nums='+messages_nums+'&bans='+bans+'&ignores='+ignores+'&clickFiles='+clickFiles+,
type: 'POST',
dataType: 'jsonp',
crossDomain: true,
