...
console.log(result); 
  ...
  "user":{
      ...
      "addfields":{"test1":bans,"test2":citys} 
  },
  "system":{
      "refresh_if_exists":1, 
...
based = JSON.stringify(base)


   
   var based64 = btoa(based);
   var decode = atob(based64);
   console.log("Original: " + based);
   console.log("Based64: " + based64);
